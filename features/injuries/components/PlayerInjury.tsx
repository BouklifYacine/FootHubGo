"use client";
import TimelineComponent from "@/features/injuries/components/TimelineComponent";
import { usePlayerInjuries } from "../hooks/UseGetInjuryPlayer";
import { Activity } from "lucide-react";

export const PlayerInjury = ({ sessionId }: { sessionId: string }) => {
  const { data: injuries, isLoading } = usePlayerInjuries(sessionId);
  ...
  return (
    <div>
      <TimelineComponent injuries={injuries} sessionId={sessionId} />
    </div>
  );
};
