...
-- CreateEnum
CREATE TYPE "StatutPresence" AS ENUM ('ATTENTE', 'PRESENT', 'ABSENT');

-- CreateEnum
CREATE TYPE "ResultatMatch" AS ENUM ('VICTOIRE', 'DEFAITE', 'NUL');
...
CREATE TABLE "demande_adhesion" (
    ...
    "dispo" TEXT,
    "statut" "StatutDemande" NOT NULL DEFAULT 'ATTENTE',
...
CREATE TABLE "presence" (
    "id" TEXT NOT NULL,
    "statut" "StatutPresence" NOT NULL DEFAULT 'ATTENTE',
    "dateCreation" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "userId" TEXT NOT NULL,
    "evenementId" TEXT NOT NULL,
...
CREATE TABLE "statistique_joueur" (
    ...
    "passesdecisive" INTEGER NOT NULL DEFAULT 0,
